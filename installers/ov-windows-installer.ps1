...
# Turn on this Python and install Open Vulnera
$env:PYENV_VERSION="3.11.7"
& pip install open-vulnera

# Get us out of this vers of Python (which was just used to setup Open Vulnera, which should stay in that vers of Python...?)
