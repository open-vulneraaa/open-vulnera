...
async def main():
    ...
    print()
    print_markdown("Welcome to **Open Vulnera**.\n")
    print_markdown("---")
    time.sleep(0.5)
    ...
    tips = [
        # "You can type `i` in your terminal to use Open Vulnera.",
        "**Tip:** Type `wtf` in your terminal to have Open Vulnera fix the last error.",
...
"""
    ...
    while not exit_flag:
        ...
        if user_input.lower() in ["exit", "quit", "q"]:
            ...
            print_markdown(
                "---\nTo get early access to the **Open Vulnera Desktop App**, please provide the following information:\n"
            )
