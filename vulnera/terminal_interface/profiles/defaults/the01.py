...
# This is an Open Vulnera.compatible profile.
# Visit https://01.openvulnera.com/profile for all options.
...
vulnera.llm.model = "claude-3.5"
# vulnera.llm.model = "gpt-4o-mini"
vulnera.llm.context_window = 100000
vulnera.llm.max_tokens = 4096
# vulnera.llm.api_key = "<your_openai_api_key_here>"

# Tell your 01 where to find and save skills
skill_path = "./skills"
vulnera.computer.skills.path = skill_path
...
vulnera.computer.import_skills = True
...
DO NOT use the.computer module for ALL tasks. Many tasks can be a.complished via Python, or by pip installing new libraries. Be creative!
...
DO NOT use the.computer module for ALL tasks. Some tasks like checking the time can be a.complished quickly via Python.
