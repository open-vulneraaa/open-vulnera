...
vulnera.display_message(
    "\n**Note:** Llama-3 is a relatively weak model, so OS mode is highly experimental. Try using a more powerful model for OS mode with `vulnera --os`."
)
vulnera.display_message("> Model set to `llama3`, experimental OS control enabled")
