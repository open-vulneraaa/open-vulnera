"""
This is an Open Vulnera profile.
"""
...
class PythonE2B:
    """
    This class contains all requirements for being a custom language in Open Vulnera:
...
# Give Open Vulnera its languages. This will only let it run PythonE2B:
vulnera.computer.languages = [PythonE2B]
