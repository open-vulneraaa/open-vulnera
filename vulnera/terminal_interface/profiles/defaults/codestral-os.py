...
if missing_packages:
    print(
        '{} isn\'t installed. Please run `pip install "open-vulnera[os]"` to install all required packages for OS mode'.format(
...
vulnera.display_message(
    "\n**Note:** Codestral is a relatively weak model, so OS mode is highly experimental. Try using a more powerful model for OS mode with `vulnera --os`."
)
vulnera.display_message("> Experimental OS control enabled.")
