...
try:
    ...
    print(
        "Some actions may fail as OS dependencies are not installed. Please run 'pip install open-vulnera[os]' to install them."
    )
...
vulnera.computer.skills.path = "./skills"

# Extra settings
vulnera.computer.import_computer_api = True
vulnera.computer.import_skills = True
vulnera.computer.run("python", "computer")  # This will trigger those imports
