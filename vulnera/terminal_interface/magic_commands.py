...
def handle_help(self, arguments):
    commands_description = {
        ...
        "%info": "Show system and vulnera information",
...
def handle_count_tokens(self, prompt):
    ...
    outputs.append(
        f"**Note**: This functionality is currently experimental and may not be accurate. Please report any issues you find to the [Open Vulnera GitHub repository](https://github.com/open-vulnera/open-vulnera)."
    )
...
def get_downloads_path():
    if is_termux():
        # For Termux, use Downloads in home directory
...
def jupyter(self, arguments):
    ...
    filename = f"open-vulnera-{formatted_time}.ipynb"
