    ...
    def notify(self, text):
        ...
        try:
            ...
            if "darwin" in platform.system().lower():  # Check if the OS is macOS
                ...
                # ## DISABLED notifier app
                # (This does not work. It makes `pip uninstall` break for some reason!)

                # ## Use custom notifier app, which lets us use a custom icon
                ...
                # # Construct the path to the notifier app
                # notifier_path = os.path.join(script_path, "notifier.app")
