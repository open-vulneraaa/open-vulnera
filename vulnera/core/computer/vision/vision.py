        ...
        with contextlib.redirect_stdout(
            ...
            if self.model == None and load_moondream:
                ...
                if self.computer.debug:
                    print(
                        "Open Vulnera will use Moondream (tiny vision model) to describe images to the language model. Set `vulnera.llm.vision_renderer = None` to disable this behavior."
                    )
                    print(
                        "Alternatively, you can use a vision-supporting LLM and set `vulnera.llm.supports_vision = True`."
                    )
