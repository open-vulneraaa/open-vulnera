...
# Rebranded: old oi_dir import removed
...
def find_icon(description, screenshot=None, debug=False, hashes=None):
    ...
    debug_path = os.path.join(os.path.expanduser("~"), "Desktop", "ov-debug")
    ...
    # Filter out extremes
    # environment keys renamed from OI_ to OV_
    min_icon_width = int(os.getenv("OV_POINT_MIN_ICON_WIDTH", "10"))
    max_icon_width = int(os.getenv("OV_POINT_MAX_ICON_WIDTH", "500"))
    min_icon_height = int(os.getenv("OV_POINT_MIN_ICON_HEIGHT", "10"))
    max_icon_height = int(os.getenv("OV_POINT_MAX_ICON_HEIGHT", "500"))
    ...
    pixel_expand = int(os.getenv("OV_POINT_PIXEL_EXPAND", 7))
    ...
    if os.getenv("OV_POINT_OVERLAP", "True") == "True":
        # renamed environment variable from OI
...
def get_element_boxes(image_data, debug):
    ...
    debug_path = os.path.join(desktop_path, "ov-debug")
    ...
    if os.getenv("OV_POINT_PERMUTATE", "False") == "True":
        import random
