...
class Skills:
    ...
    OpenVulnera with import_skills=True.
    ...
    def __init__(self, computer):
        ...
        self.path = str(Path(ov_dir) / "skills")
    ...
    def list(self):
        ...
        if not self.computer.import_skills:
            print("Skills are disabled. To enable skills, either use a profile like 'the01' that supports skills, "
                  "or create an instance of OpenVulnera with import_skills=True")
            return []
    ...
    def import_skills(self):
        ...
        if self.computer.vulnera.debug:
