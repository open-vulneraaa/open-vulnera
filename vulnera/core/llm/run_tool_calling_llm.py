        ...
        "parameters": {
            ...
            "properties": {
                "language": {
                    ...
                    "enum": [
                        # This will be filled dynamically with the languages Open Vulnera has access to.
                    ],
                },
                "code": {
                    "type": "string",
...
def run_tool_calling_llm(llm, request_params):
    ...
    # Add languages Open Vulnera has access to
    tool_schema["function"]["parameters"]["properties"]["language"]["enum"] = [
        i.name.lower() for i in llm.vulnera.computer.terminal.languages
    ]
