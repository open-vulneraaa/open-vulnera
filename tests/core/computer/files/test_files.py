...
from vulnera.core.computer.files.files import Files
...
class TestFiles(unittest.TestCase):
    ...
    @mock.patch("vulnera.core.computer.files.files.aifs")
    ...
    def test_edit_original_text_in_filedata(self):
        ...
        # Act
        with mock.patch("vulnera.core.computer.files.files.open", mock_open):
