...
Open Vulnera playing some Lofi using OS mode:
...
#### Open Vulnera Chatting with Open Vulnera

OS mode creating and chatting with a local instance of Open Vulnera:
...
Open Vulnera describing pictures it wants to make, then creating them using OS mode:
...
#### Open Vulnera Conversing With ChatGPT
