...
Magic commands can be used to control the vulnera's behavior in interactive mode:

- `%% [shell commands, like ls or cd]`: Run commands in Open Vulnera's shell instance
