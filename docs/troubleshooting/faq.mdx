...
<Accordion title="Does Open Vulnera ensure that my data doesn't leave my computer?">
  ...
  [function](https://github.com/open-vulnera/open-vulnera/blob/main/vulnera/core/core.py#L167)
  (copied over from ChromaDB's telemetry) that anonymously tracks usage. This
  only lets us know if a message was sent, includes no PII. Open Vulnera errors will also
