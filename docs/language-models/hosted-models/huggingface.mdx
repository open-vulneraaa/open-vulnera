...
To use Open Vulnera with Huggingface models, set the `model` flag:

<CodeGroup>

```bash Terminal
vulnera --model huggingface/<huggingface-model>
```

```python Python
from vulnera import vulnera

vulnera.llm.model = "huggingface/<huggingface-model>"
vulnera.chat()
```
...
```bash Terminal
vulnera --api_base <https://my-endpoint.huggingface.cloud>
```

```python Python
from vulnera import vulnera

vulnera.llm.api_base = "https://my-endpoint.huggingface.cloud"
vulnera.chat()
```
...
Open Vulnera should work with almost any text based hugging face model.
