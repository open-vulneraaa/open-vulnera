...
**Open Vulnera** works with both hosted and local language models.
...
For this reason, we recommend starting with a **hosted** model, then switching to a local model once you've explored Open Vulnera's capabilities.
...
<Info>
  ...
  efforts in connecting Open Vulnera to hosted providers.
</Info>
